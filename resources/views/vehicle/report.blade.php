    ...
    <div class="card-body">
        ...
        <form id="filterForm" class="mb-4" onsubmit="event.preventDefault(); loadReport();">
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    ...
                    <select id="employees" class="form-control select2" multiple>
                        ...
                        @foreach ($employees as $emp)
                            <option value="{{ $emp->id }}">{{ $emp->emp_name }}({{ $emp->vehicle_no }})</option>
                        @endforeach
                    </select>
                </div>
                ...
                <!-- IN GATE -->
                <div class="col-md-3">
                    <label class="font-weight-bold">Gate</label>
...
function loadReport() {
    ...
    fetch("{{ url('/api/vehicle/attendence/report') }}?" + new URLSearchParams(params))
        .then(res => res.json())
