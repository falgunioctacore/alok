...
<div class="d-flex justify-content-between align-items-center">
    ...
    <div class="btn-group">
        <button id="addBtn" class="btn btn-primary  btn-sm px-3">
            <i class="fa fa-plus mr-1"></i> Add Plant
        </button>
        <button id="importBtn" class="btn btn-secondary  btn-sm px-3 ml-2" data-toggle="modal"
...
<div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form id="importForm" method="POST" action="{{ url('plants/import') }}" enctype="multipart/form-data"
            class="w-100">
            @csrf
